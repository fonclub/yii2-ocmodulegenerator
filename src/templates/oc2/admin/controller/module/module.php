...
class ControllerModule{{moduleClassName}} extends Controller
{
    ...
    {
        $data = $this->load->language('module/{{moduleName}}');
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            ...
            $this->response->redirect($this->url->link('module/{{moduleName}}',
                'token='.$this->session->data['token'], 'SSL'));
        }

        $data['demoData'] = $this->model_module_{{moduleName}}->getDemoData();
        ...
        $data['action'] = $this->url->link('module/{{moduleName}}', 'token='.$this->session->data['token'], 'SSL');
        ...
        $this->response->setOutput($this->load->view('module/{{moduleName}}.tpl', $data));
    }
